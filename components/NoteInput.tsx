    ...
    >
      ...
      <div className="p-5">
        ...
        <textarea
          ...
          rows={3}
          className="w-full text-sm text-gray-700 placeholder:text-gray-300 bg-transparent resize-none focus:outline-none leading-relaxed mb-3"
        />
        ...
        <div className="flex items-center justify-between">
          <span className="text-xs text-gray-300">
            {content.length > 0 ? `${content.length} chars · ⌘↵ to save` : ""}
          </span>
          <button
            onClick={handleSave}
